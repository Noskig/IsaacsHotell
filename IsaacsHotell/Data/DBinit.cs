        ...
        public static void Initialiser(HotellDbContext context)
        {
            ...
            if (!context.Rum.Any())
            {
                ...
                var rum = new List<Rum> {
                                    new Rum{Namn="Jan",Antalsovplatser=2, Smutsigt=false, },
                                    new Rum{Namn="Feb",Antalsovplatser=2, Smutsigt=false, },
                                    new Rum{Namn="Mar",Antalsovplatser=2, Smutsigt=false, },
                                    new Rum{Namn="Apr",Antalsovplatser=2, Smutsigt=false, },
                                    new Rum{Namn="Maj",Antalsovplatser=2, Smutsigt=false, },
